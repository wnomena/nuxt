...
<section>
    <div class="d-flex justify-content-between">
        ...
        <span style="align-items: center; width: 250px" class="return me-1 bg-primary d-flex justify-content-center">
            <i class="bi bi-chevron-left"> <NuxtLink to="/internal-footer/menu-for-admin/admin-manager" class="text-light text-decoration-none"> Add new</NuxtLink> </i>
        </span>
    ...
    <div class="commentary_list" v-for="i in contact_dom.list_table" :key="i.mail.toString()">
        <div class="container-fluid d-flex justify-content-between">
            ...
            <div @click="delete_member(i.mail.toString())" class="delete_member rounded border d-flex justify-content-center"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="40" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
...
function delete_member(mail : string) {
    HttpService.delete_member(mail)
}
</script>
