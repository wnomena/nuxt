<template>
  <section class="row">
    <div class=" bg-primary col-12 pt-2 pb-2">
        <div class="container">
            <div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
                <div class="col-lg-12 d-block">
                    <div class="row d-none d-md-flex justify-content-between">
                        <div class="col-6 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
                            <span class="text">Adventure & Sensation in Madagascar.</span>
                        </div>
      
                        <div class="col-lg-3 pr-4 d-lg-flex d-none topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                            <span class="text"> <i class="fas fa-paper-plane"><i class="bi bi-envelope"></i> wnomena58@gmail.com</i></span>
                        </div>
      ...
      <div class="bgc-undefined text-light col-12">
          <div class="d-flex justify-content-between col-12">
              <div class="p-0 m-0">
                  <h3 class="m-1 p-0 h-auto fs-lg-3 fs-md-4 fs-5">CAP ON MADA</h3>
              </div>
              <div class="col-6 h-auto p-0">
                <div class="full-screen col-12 p-0 m-0 d-flex">
                    ...
                    <span v-if="mail !== ''" class="d-flex align-items-center justify-content-center flex-nowrap col-4 ms-1 p-1" data-bs-toggle="collapse" data-bs-target="#collapseExample"><i type="button" class="bi bi-people-fill"></i><small class="d-lg-flex align-items-center d-md-none d-none ms-1">{{ mail }}</small></span>
...
const mail = computed(() => {
    ...
    return storage_for_token.get_mail()
})
</script>
<style scoped>
...
.row .bgc-undefined .container .col-6 .me-2,.row .bgc-undefined .container .col-6 .me-2 .pe-2{
    height: 100%;
}
</style>
