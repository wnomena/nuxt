          ...
          <div class="d-flex justify-content-between col-12">
              ...
              <div class="col-6 h-auto p-0">
                <div class="full-screen col-12 p-0 m-0 d-flex">
                    ...
                    <span v-if="mail.mail" class="d-flex align-items-center justify-content-center flex-nowrap col-4 ms-1 p-1" @click="deco" data-bs-toggle="collapse" data-bs-target="#collapseExample"><i type="button" class="bi bi-people-fill"></i><small class="d-lg-flex align-items-center d-md-none d-none ms-1">{{ mail.mail }}</small></span>
...
const deco = () => { Teste.delete(),navigateTo("/")}
</script>
<style scoped>
  span {
